...
int main(){
	...
	cerr << "\n\tEXTRA CREDIT: print out a tree of 20 random elements in tree form. Moore approved this method.\n" << endl;
	BSTree extraCreditTree;
	for(int i = 0; i < 20; i++) {
		int value = rand() % 100;
		if (!extraCreditTree.insert(value)) i--;
	}
	extraCreditTree.startPrintTree();
	//delete extraCreditTree;
